                ...
                <div className="row">
                    <div className="col-xl-4 col-lg-4 col-sm-6">
                        <div className="kservice-2 mb-30 wow fadeInUp">
                            <div className="kservice-text-2">
                                <span>Services</span>
                                <h4 className="kservice-title-2"><Link to="/website-design">Website Design</Link></h4>
                    ...
                    <div className="col-xl-4 col-lg-4 col-sm-6">
                        <div className="kservice-2 mb-30 wow fadeInUp">
                            <div className="kservice-text-2">
                                <span>Services</span>
                                <h4 className="kservice-title-2"><Link to="/branding">Branding</Link></h4>
                    ...
                    <div className="col-xl-4 col-lg-4 col-sm-6">
                        <div className="kservice-2 mb-30 wow fadeInUp">
                            <div className="kservice-text-2">
                                <span>Services</span>
                                <h4 className="kservice-title-2"><Link to="/graphic-design">Graphic Design</Link></h4>
