                    ...
                    <div className="row align-items-center wow fadeInUp" data-wow-delay=".3s">
                        <div className="col-lg-6">
                            <div className="team__founder-thumb w-img mb-60">
                                <img src="/assets/img/team/team-img-6.jpg" alt="img not found" />
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="team__founder-main mb-60">
                                <div className="section__title-wrapper mb-35">
                                    <div className="section-title-wrapper">
                                        <h5 className="section-subtitle mb-20">Art Director</h5>
                                        <h2 className="section-title mb-35">Allen Van Luu</h2>
                                    </div>
                                    <p className="paragraph-2">Illustration and Design professional with over ten years experience designing and illustrating various forms of visuals in NYC for mass apparel, select small businesses, B2B, B2C, in corporate and national retail headquarters.</p>
                                </div>
