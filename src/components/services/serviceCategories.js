        ...
        <section className="service-area service-area2 pt-115 pb-100" style={{ backgroundImage: "url(/assets/img/service/service-bg.jpg)" }}>
            <div className="container">
                ...
                <div className="row custom-mar-20" data-aos="fade-down" data-aos-duration="1000">
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-sm-6 custom-pad-20">
                        <div className="kservice text-center mb-20">
                            <div className="kservice-icon">
                                <i className="flaticon-analytics"></i>
                            </div>
                            <div className="kservice-content">
                                <h5 className="kservice-content-title"><Link to="/website-design">Website Design</Link></h5>
                            </div>
                        </div>
                    </div>
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-sm-6 custom-pad-20">
                        <div className="kservice text-center mb-20">
                            ...
                            <div className="kservice-content">
                                <h5 className="kservice-content-title"><Link to="/branding">Branding</Link></h5>
                            </div>
                        </div>
                    </div>
                    {/* <div className="col-xxl-3 col-xl-3 col-lg-3 col-sm-6 custom-pad-20">
                        <div className="kservice text-center mb-20">
                            ...
                            <div className="kservice-content">
                                <h5 className="kservice-content-title"><Link to="/service-details">SEO & Content <br />writting</Link></h5>
                            </div>
                        </div>
                    </div> */}
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-sm-6 custom-pad-20">
                        <div className="kservice text-center mb-20">
                            ...
                            <div className="kservice-content">
                                <h5 className="kservice-content-title"><Link to="/graphic-design">Graphic Design</Link></h5>
                            </div>
                        </div>
                    </div>
                </div>
