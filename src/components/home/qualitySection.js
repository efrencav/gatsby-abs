                    ...
                    <div className="col-lg-8">
                        <div className="kquality mb-30" data-aos="zoom-in-right">
                            <div className="kquality-icon">
                                <img src="/assets/img/icon/service-icon-1a.png" className="img-fluid" alt="desktop monitor icon with text and lines through" />
                            </div>
                    ...
                    <div className="col-lg-4">
                        <div className="text-lg-end mb-30" data-aos="zoom-in-left">
                            <div className="kquality-img">
                                <img src="/assets/img/trust/cta-img.jpg" className="img-fluid" alt="hands typing on a laptop keyboard with colored penciles around" />
                            </div>
                        </div>
                    </div>
                </div>
