                ...
                <div className="row">
                    <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-12">
                        <div className="p-details-content mb-40">
                            ...
                            <div className="row">
                                <div className="col">
                                    <img className='mb-20' src="/assets/img/project/six-ways-14.jpg" alt="Coffee packaging" />
                                </div>
                                <div className="col">
                                    <img className='mb-20' src="/assets/img/project/six-ways-15.jpg" alt="Coffee packaging" />
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col">
                                    <img className='mb-20' src="/assets/img/project/six-ways-13.jpg" alt="Coffee packaging" />
                                </div>
                                <div className="col">
                                    <img className='mb-20' src="/assets/img/project/six-ways-15.jpg" alt="Coffee packaging" />
                                </div>
                            ...
                            <div className="row">
                                <div className="col">
                                    <img className='mb-20' src="/assets/img/project/six-ways-12.jpg" alt="Coffee packaging" />
                                </div>
                                <div className="col">
                                    <img className='mb-20' src="/assets/img/project/six-ways-11.jpg" alt="Coffee packaging" />
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col">
                                    <img className='mb-20' src="/assets/img/project/six-ways-10.jpg" alt="Coffee packaging" />
                                </div>
                                <div className="col">
                                    <img className='mb-20' src="/assets/img/project/six-ways-8.jpg" alt="Coffee packaging" />
                                </div>
                            </div>
