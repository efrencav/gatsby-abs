...
const Breadcrumbtwo = ({ breadcrumbTitle, breadcrumbSubTitle }) => {
    return (
        <section className="page-title-area breadcrumb-spacing" style={{ backgroundImage: "url(/assets/img/bg/breadcrumb-bg2.jpg)" }}>
